<div class="card">
    <div class="card-body">
        ...
        @endif
        <form id="comform" method="POST" action="{{ route('comments.store') }}">
            @csrf
            @honeypot
            ...
            <button id="backBtn" type="submit" class="btn btn-sm btn-outline-success text-uppercase">@lang('comments::comments.submit')</button>
        </form>
    </div>
</div>
<br />